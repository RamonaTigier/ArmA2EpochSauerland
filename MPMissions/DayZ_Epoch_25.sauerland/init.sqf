...
//Open Custom AsReMix Player HUD start
DZE_AsReMix_PLAYER_HUD = true; 
//Open Custom AsReMix Player HUD end
...
call compile preprocessFileLineNumbers "compiles.sqf";				//Compile regular functions (MF-Tow)
...
if (!isDedicated) then {
	...
	// Autorepair, autorefuel autorearm at servicepoint
