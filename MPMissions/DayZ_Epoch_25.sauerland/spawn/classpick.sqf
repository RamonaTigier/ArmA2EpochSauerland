private ["_classHover","_donorUID","_go","_hlevel","_humanity","_itemText","_level","_selectedItem"];
...
{if (_itemText == (_x select 0)) then {_classHover = _x;};} forEach donorListClasses;
